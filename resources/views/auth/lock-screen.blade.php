            ...
            <div class="2xl:w-1/4 lg:w-1/3 md:w-1/2 w-full">
                <div class="card overflow-hidden sm:rounded-md rounded-none">
                    <div class="p-6">
                        <div class="flex justify-between">
                            <div class="flex flex-col gap-4 mb-6">
                                <a href="{{ route('any', 'index') }}" class="block">
                                    ...
                                    <img class="h-6 hidden dark:block" src="/images/level-up-light.jpg">
                                </a>
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-center">Not you ? return<a
                                href="{{ route('second', ['auth', 'login']) }}" class="text-primary ms-1"><b>Log
                                    In</b></a></p>
                    </div>
                </div>
            </div>
